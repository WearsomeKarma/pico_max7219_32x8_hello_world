...
static void write_registers(uint8_t data[NUM_MODULES][8])  {
    uint8_t buf[2];
    for (int i=0;i<8;i++) {
        buf[0] = CMD_DIGIT0 + i;
        cs_select();
...
#warning spi/max7219_32x8_spi example requires a board with SPI pins
    ...
    uint8_t data[NUM_MODULES][8];

    for (int i=0;i<8;i++) for (int j=0;j<NUM_MODULES;j++) data[j][i] = 0;

    data[0][0] = (1 << 7)            | (1 << 5)            | (1 << 3) | (1 << 2) | (1 << 1)    ;
    data[0][1] = (1 << 7)            | (1 << 5)            | (1 << 3) | (1 << 2) | (1 << 1)    ;
    data[0][2] = (1 << 7) | (1 << 6) | (1 << 5)            | (1 << 3)                          ;
    data[0][3] = (1 << 7)            | (1 << 5)            | (1 << 3) | (1 << 2) | (1 << 1)    ;

    data[1][0] = (1 << 7)                       | (1 << 4)                                  | 1;
    data[1][1] = (1 << 7)                       | (1 << 4)                       | (1 << 1)    ;
    data[1][2] = (1 << 7)                       | (1 << 4)                       | (1 << 1)    ;
    data[1][3] = (1 << 7) | (1 << 6)            | (1 << 4) | (1 << 3)                       | 1;
    ...
    data[3][4] =                       (1 << 5)                                   | (1 << 1)    ;
    data[3][5] = (1 << 7)            | (1 << 5)                                   | (1 << 1)    ;
    data[3][6] =                       (1 << 5)                        | (1 << 2) | (1 << 1)    ;
    data[3][7] =                       (1 << 5) | (1 << 4)             | (1 << 2) | (1 << 1) | 1;

    data[2][4] =            (1 << 6)                        | (1 << 3)                          ;
    data[2][5] =            (1 << 6)             | (1 << 4)            | (1 << 2)            | 1;
    data[2][6] =            (1 << 6)             | (1 << 4)            | (1 << 2)            | 1;
    data[2][7] = (1 << 7)                                   | (1 << 3)                       | 1;
